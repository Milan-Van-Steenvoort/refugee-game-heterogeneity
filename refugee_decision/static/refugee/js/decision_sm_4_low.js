...
output2_sm_4.innerHTML = (0).toFixed(2);
output3_sm_4.innerHTML = (0).toFixed(2);
...
rangeslider_4.oninput = function() {
	...
	output2_sm_4.innerHTML = ((((100 - this.value)/4)/100)*(40)).toFixed(2);
	output3_sm_4.innerHTML = output2_sm_4.innerHTML;
	output4_sm_4.innerHTML = (((this.value*1)/100)*(40)).toFixed(2);
}
