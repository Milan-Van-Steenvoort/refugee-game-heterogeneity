...
output2_sm_3.innerHTML = (0).toFixed(2);
output3_sm_3.innerHTML = (0).toFixed(2);
...
rangeslider_3.oninput = function() {
	...
	output2_sm_3.innerHTML = ((((100 - this.value)/4)/100)*(120)).toFixed(2);
	output3_sm_3.innerHTML = output2_sm_3.innerHTML;
	output4_sm_3.innerHTML = (((this.value*1)/100)*(120)).toFixed(2);
}