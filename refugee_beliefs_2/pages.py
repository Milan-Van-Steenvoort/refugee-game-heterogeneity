...
class ref_sim_hh(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_seqsim') & (self.round_number == self.player.participant.vars['task_rounds_sim']['ref_sim_hh'])
...
class ref_sim_hl_lh(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_seqsim') & (self.round_number == self.player.participant.vars['task_rounds_sim']['ref_sim_hl_lh'])
...
class ref_sim_ll(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_seqsim') & (self.round_number == self.player.participant.vars['task_rounds_sim']['ref_sim_ll'])
...
class ref_seq_hh(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_simseq') & (self.round_number == self.player.participant.vars['task_rounds_seq']['ref_seq_hh'])
...
class ref_seq_hl(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_simseq') & (self.round_number == self.player.participant.vars['task_rounds_seq']['ref_seq_hl'])
...
class ref_seq_lh(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_simseq') & (self.round_number == self.player.participant.vars['task_rounds_seq']['ref_seq_lh'])
...
class ref_seq_ll(Page):
    ...
    def is_displayed(self):
        return (self.player.treatment == 'refugee_simseq') & (self.round_number == self.player.participant.vars['task_rounds_seq']['ref_seq_ll'])
